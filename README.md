...
`/config/custom_components/fujitsu_general_heatpump.py/climate.py`
`/config/custom_components/fujitsu_general_heatpump.py/manifest.json`
`/config/custom_components/fujitsu_general_heatpump.py/init.py`
